...
```
 ...
 If you want to run ANOVA then you should make treatment as a factor
 but if you want regression treatment shlould be in character. Intersting thing is model will be same for both ANOVA and regression 
```{r rcbd_dfw}
...
spp_rcbd_mix_mod <- lmer(data = spp_rcbd_dfw,
                         formula = yield_kgha ~ (1|block/krate_kgha
...
In rcbd letters separation are upto “a” to “e”, whereas in split plot rcbd letters given are upto “a” to “d”. 
